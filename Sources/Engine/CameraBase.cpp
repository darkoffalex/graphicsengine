...
{
	// TODO: Используя подобный подход невозможно сделать камеры поворачивающуюся 
	// TODO: вокруг оси Z. Добавление угла по этой оси ведет лишь к искажению воротов
	// TODO: по остальным углам (из-за того угол участвует лишь в формирвоании направления,
