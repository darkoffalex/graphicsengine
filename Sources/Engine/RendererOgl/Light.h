...
namespace ogl
{
	...
	enum LightType
	{
		POINT_LIGHT = 1,        // Точечный источник (распространяется во всех направлениях)
		DIRECTIONAL_LIGHT = 2,  // Нправленный-параллельный (бесконечно отдаленный, например солнце)
		SPOT_LIGHT = 3          // Направленный из одной точки (фанарик, прожектор)
	};
